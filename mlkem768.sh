...
WANT_LIBCRUX_REVISION=${WANT_LIBCRUX_REVISION-origin/main}
abs_builddir="$PWD"
srcdir=`dirname $0`
...
) > $abs_builddir/libcrux_mlkem768_sha3.h_new
...
cc -Wall -Wextra -Wno-unused-parameter \
	-Dcrypto_kem_mlkem768_PUBLICKEYBYTES=1184 \
	-Dcrypto_kem_mlkem768_SECRETKEYBYTES=2400 \
	-Dcrypto_kem_mlkem768_CIPHERTEXTBYTES=1088 \
	-Dcrypto_kem_mlkem768_BYTES=32 \
	-o libcrux_mlkem768_sha3_check \
...
mv libcrux_mlkem768_sha3.h_new $srcdir/libcrux_mlkem768_sha3.h
